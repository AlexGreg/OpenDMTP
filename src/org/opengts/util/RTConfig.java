...
public class RTConfig
{
    ...
    **/
    protected static synchronized void _startupInit(boolean allowChangeSystemProperties)
    {
        ...
        if (getBoolean(RTKey.DEBUG_MODE)) {
    ...
    **/
    ...
    /**
    *** Adds the properties in the specified <code>Map</code> to the config 
    *** file properties
    *** @param props  The map from which properties will be loaded
    **/
    ...
    **/
    public static void main(String argv[])
    {
        ...
        if (RTConfig.hasProperty("test")) {
            ...
            String s = StringTools.blankDefault(RTConfig.getString("test",null),"Test String: ${value}");
