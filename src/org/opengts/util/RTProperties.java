    ...
    RTConfig.PropertySetter, RTConfig.PropertyGetter
{
    ...
    *** @see StringTools#insertKeyValues
    **/
    public String _insertKeyValues(final Object mainKey, String text, String startDelim, String endDelim, final String dftDelim)
    {
        if (text != null) {
    ...
    **/
    public String toString(RTProperties exclProps, Collection<?> orderBy, String newLinePrefix)
    {
        ...
        if (!n.equals("")) {
            ...
            sb.append(n).append(NameSeparatorChar);
            if (inclNewLine) {
                sb.append("\n");
            } else {
    ...
    **/
    ...
    /**
    *** Loads the properties from the specified <code>InputStream</code> into
    *** the specified <code>Properties</code>
    *** @param props The properties container to load the properties into
    ...
    **/
    public static void main(String argv[])
    {
        ...
        */
        ...
        RTProperties rtp = new RTProperties("-test=\"Hello World\" -another=test");
