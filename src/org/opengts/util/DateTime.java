  ...
  //public static final int MAY       = MAY;
    ...
    **/
    public static DateTime parseArgumentDate(String dateStr)
        throws DateParseException
    {
        return DateTime.parseDateTime(dateStr, DateTime.getGMTTimeZone(), false).createDateTime();
    }
    ...
    **/
    public double getYearsSince(long priorDayNumber, TimeZone tz)
    {
        ...
        ParsedDateTime thisPDT = DateTime.getDateFromDayNumber(thisDayNumber);
        ParsedDateTime thatPDT = DateTime.getDateFromDayNumber(thatDayNumber);
    ...
    **/
    public static void main(String argv[])
    {
        ...
        long pstNowDayN = DateTime.getDayNumberFromDate(new DateTime(pstTZ));
        Print.sysPrintln("PST Day#  : " + pstDayN + " [DOW=" + ((pstDayN + 5) % 7) + ", DaysFromNow=" + (pstDayN - pstNowDayN) + "]");
        Print.sysPrintln("");
