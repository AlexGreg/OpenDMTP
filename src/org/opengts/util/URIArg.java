...
public class URIArg
{
    ...
    **/
    public static RTProperties decodeRTP(String rtpArg)
    {
    ...
    **/
    public static boolean isAbsoluteURL(String url)
    {
        if (url == null) {
            ...
            // per "http://en.wikipedia.org/wiki/URI_scheme" all URL "schems" contain only
    ...
    **/
    ...
    /**
    *** Removes all occurances of the specified argument from the URI
    *** @param key The key to remove
    *** @return This URIArg, with the argument added
    **/
    protected URIArg removeArg(String key)
    {
        if (key != null) {
    ...
    **/
    ...
    /**
    *** If the specified argument exists, set the specified value and return true
    ...
    public URIArg rtpDecode(String rtpKey)
    {
        ...
        for (KeyVal kv : this.getKeyValList()) {
            ...
            if (!kn.equals(rtpKey)) {
                ...
                RTProperties rtp = URIArg.decodeRTP(kv.getValue());
