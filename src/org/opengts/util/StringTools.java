...
public class StringTools
{
  ...
  //private static final String DefaultCharEncoding     = CharEncoding_8859_1;
    ...
    **/
    public static String toStringValue(byte b[], char repUnp)
    {
        if (b != null) {
            ...
            return StringTools.toStringValue(p, 0, -1);
        } else {
            return null;
        }
    }
    ...
    *** @param ch  The hex digit to test
    ...
    **/
    ...
    {
        return replaceKeys(text, keyMap, null, null, null);
    }
    ...
    **/
    ...
    {
        return replaceKeys(text, keyMap, filter, null, null);
    }
    ...
    **/
        ...
        String keyStart, String keyEnd)
    {
        ...
        for (;(ks >= 0);) {
            ...
            String kv = (keyMap != null)? keyMap.getKeyValue(key,arg) : null;
