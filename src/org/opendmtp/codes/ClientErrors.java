...
// Upload errors (data provides specifics):
    ...
    public static final int ERROR_UPLOAD_PACKET                 = 0xF405;
    // Description:
    //      Invalid specified upload packet type
    // Payload:
    //      0:2 - This error code
    // Notes:
    //      Sent to the server when an upload packet type is not recognized.
    ...
    public static final int ERROR_UPLOAD_HOST                   = 0xF451;
    // Description:
    //      Invalid/unspecified upload host or port
    // Payload:
    //      0:2 - This error code
    //      2:X - Additional diagnostic information as needed.
    // Notes:
    //      Sent to the server when the client is unable to determine the 
    //      upload host or port

    public static final int ERROR_UPLOAD_SERVER_ERROR           = 0xF461;
    // Description:
    //      Server indicated error during upload
    // Payload:
    //      0:2 - This error code
    //      2:X - Additional diagnostic information as needed.
    // Notes:
    //      Sent to the server when the client has terminated a file upload due
    //      to an error indicated by the server.
...
// Internal errors (data provides specifics):
    ...
    public static final int ERROR_OUT_OF_MEMORY                 = 0xFE00;
    // Description:
    //      Client encountered an out-of-memory error
    // Payload:
    //      0:2 - This error code
    //      2:X - Additional diagnostic information as needed.
    // Notes:
    //      Sent to the server when the client has encounted an out of memory error.

    public static final int ERROR_INTERNAL_ERROR_00             = 0xFEE0;
    public static final int ERROR_INTERNAL_ERROR_01             = 0xFEE1;
    public static final int ERROR_INTERNAL_ERROR_02             = 0xFEE2;
    public static final int ERROR_INTERNAL_ERROR_03             = 0xFEE3;
    public static final int ERROR_INTERNAL_ERROR_04             = 0xFEE4;
    public static final int ERROR_INTERNAL_ERROR_05             = 0xFEE5;
// ...
    public static final int ERROR_INTERNAL_ERROR_0F             = 0xFEEF;
    // Description:
